...
// Ajustando para senha vazia ou outra senha conforme configurado no seu ambiente
const dbConfig = {
  host: 'localhost', // Ou o IP/endereço do seu servidor MySQL
  user: 'root',      // Seu usuário do MySQL
  password: 'Aninha2007',      // Senha vazia para MySQL padrão ou ajuste conforme sua configuração
